"use strict";
(this["webpackChunkYtomoExtension"] = this["webpackChunkYtomoExtension"] || []).push([[959],{
...
// UNUSED EXPORTS: BaseTransition, BaseTransitionPropsValidators, Comment, DeprecationTypes, EffectScope, ErrorCodes, ErrorTypeStrings, KeepAlive, ReactiveEffect, Static, Suspense, Teleport, Text, TrackOpTypes, Transition, TransitionGroup, TriggerOpTypes, VueElement, assertNumber, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize, cloneVNode, compatUtils, compile, createBlock, createHydrationRenderer, createPropsRestProxy, createRenderer, createSSRApp, createSlots, createStaticVNode, customRef, defineAsyncComponent, defineCustomElement, defineEmits, defineExpose, defineModel, defineOptions, defineProps, defineSSRCustomElement, defineSlots, devtools, effect, getCurrentInstance, getCurrentWatcher, getTransitionRawChildren, guardReactiveProps, h, handleError, hydrate, hydrateOnIdle, hydrateOnInteraction, hydrateOnMediaQuery, hydrateOnVisible, initCustomFormatter, initDirectivesForSSR, isMemoSame, isProxy, isReadonly, isRuntimeOnly, isShallow, isVNode, mergeDefaults, mergeModels, mergeProps, normalizeProps, normalizeStyle, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onRenderTracked, onRenderTriggered, onServerPrefetch, onUpdated, onWatcherCleanup, popScopeId, provide, proxyRefs, pushScopeId, queuePostFlushCb, readonly, registerRuntimeCompiler, render, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveFilter, resolveTransitionHooks, setBlockTracking, setDevtoolsHook, setTransitionHooks, shallowReactive, shallowReadonly, shallowRef, ssrContextKey, ssrUtils, stop, toHandlerKey, toHandlers, toValue, transformVNodeArgs, triggerRef, useAttrs, useCssModule, useCssVars, useHost, useId, useModel, useSSRContext, useShadowRoot, useSlots, useTemplateRef, useTransitionState, vModelDynamic, vModelRadio, vShow, version, warn, watchEffect, watchPostEffect, watchSyncEffect, withAsyncContext, withCtx, withDefaults, withMemo, withScopeId
...
// UNUSED EXPORTS: MutationType, PiniaVuePlugin, acceptHMRUpdate, disposePinia, getActivePinia, mapActions, mapGetters, mapState, mapStores, mapWritableState, setActivePinia, setMapStoreSuffix, shouldHydrate, skipHydrate, storeToRefs
                ...
                Object.values(piniaStores).forEach((store) => {
                    payload.instanceData.state.push({
                        ...
                        value: store._isOptionsAPI
                            ? {
                                _custom: {
                                    value: (0,vue_esm_bundler/* toRaw */.ux)(store.$state),
                                    actions: [
                                        {
                                            icon: 'restore',
            ...
            if (payload.app === app && payload.inspectorId === INSPECTOR_ID) {
                ...
                if (inspectedStore) {
                    ...
                    if (payload.nodeId !== PINIA_ROOT_ID)
                        globalThis.$store = (0,vue_esm_bundler/* toRaw */.ux)(inspectedStore);
...
function addStoreToDevtools(app, store) {
    ...
    setupDevtoolsPlugin({
        ...
        store._customProperties.forEach((name) => {
            (0,vue_esm_bundler/* watch */.wB)(() => (0,vue_esm_bundler/* unref */.R1)(store[name]), (newValue, oldValue) => {
        ...
        store._hotUpdate = (0,vue_esm_bundler/* markRaw */.IG)((newStore) => {
            hotUpdate(newStore);
            api.addTimelineEvent({
                layerId: MUTATIONS_LAYER_ID,
                event: {
...
function patchActionForGrouping(store, actionNames, wrapWithProxy) {
    ...
    const actions = actionNames.reduce((storeActions, actionName) => {
        ...
        storeActions[actionName] = (0,vue_esm_bundler/* toRaw */.ux)(store)[actionName];
        return storeActions;
    }, {});
...
function devtoolsPlugin({ app, store, options }) {
    ...
    if (!store._p._testing) {
        ...
        (0,vue_esm_bundler/* toRaw */.ux)(store)._hotUpdate = function (newStore) {
...
function createPinia() {
    const scope = (0,vue_esm_bundler/* effectScope */.uY)(true);
    // NOTE: here we could check the window object for a state and directly set it
    // if there is anything like it with Vue 3 SSR
    const state = scope.run(() => (0,vue_esm_bundler/* ref */.KR)({}));
    let _p = [];
    // plugins added before calling app.use(pinia)
    let toBeInstalled = [];
    const pinia = (0,vue_esm_bundler/* markRaw */.IG)({
        install(app) {
...
function addSubscription(subscriptions, callback, detached, onCleanup = noop) {
    ...
    if (!detached && (0,vue_esm_bundler/* getCurrentScope */.o5)()) {
        (0,vue_esm_bundler/* onScopeDispose */.jr)(removeSubscription);
    }
...
function mergeReactiveObjects(target, patchToApply) {
    ...
    for (const key in patchToApply) {
        ...
        if (isPlainObject(targetValue) &&
            ...
            !(0,vue_esm_bundler/* isRef */.i9)(subPatch) &&
            !(0,vue_esm_bundler/* isReactive */.g8)(subPatch)) {
...
function isComputed(o) {
    return !!((0,vue_esm_bundler/* isRef */.i9)(o) && o.effect);
}
    ...
    function setup() {
        ...
        const localState =  false
            ? // use ref() to unwrap refs inside state TODO: check if this is still necessary
                0
            : (0,vue_esm_bundler/* toRefs */.QW)(pinia.state.value[id]);
        return pinia_assign(localState, actions, Object.keys(getters || {}).reduce((computedGetters, name) => {
            if (false) // removed by dead control flow
{}
            computedGetters[name] = (0,vue_esm_bundler/* markRaw */.IG)((0,vue_esm_bundler/* computed */.EW)(() => {
                setActivePinia(pinia);
...
{}
    ...
    const hotState = (0,vue_esm_bundler/* ref */.KR)({});
...
{}
        ...
        (0,vue_esm_bundler/* nextTick */.dY)().then(() => {
    ...
    const _hmrPayload = /*#__PURE__*/ (0,vue_esm_bundler/* markRaw */.IG)({
        actions: {},
        getters: {},
        state: [],
        hotState,
    ...
    const partialStore = {
        ...
        $subscribe(callback, options = {}) {
            ...
            const stopWatcher = scope.run(() => (0,vue_esm_bundler/* watch */.wB)(() => pinia.state.value[$id], (state) => {
    ...
    const store = (0,vue_esm_bundler/* reactive */.Kh)(( false) || (((( false) || (typeof __VUE_PROD_DEVTOOLS__ !== 'undefined' && __VUE_PROD_DEVTOOLS__)) && !("production" === 'test')) && IS_CLIENT)
        ? pinia_assign({
            _hmrPayload,
            _customProperties: (0,vue_esm_bundler/* markRaw */.IG)(new Set()), // devtools custom properties
        }, partialStore
        // must be added later
        // setupStore
        )
    ...
    const setupStore = runWithContext(() => pinia._e.run(() => (scope = (0,vue_esm_bundler/* effectScope */.uY)()).run(() => setup({ action }))));
    // overwrite existing actions to support $onAction
    for (const key in setupStore) {
        const prop = setupStore[key];
        if (((0,vue_esm_bundler/* isRef */.i9)(prop) && !isComputed(prop)) || (0,vue_esm_bundler/* isReactive */.g8)(prop)) {
...
{}
                ...
                if (initialState && shouldHydrate(prop)) {
                    if ((0,vue_esm_bundler/* isRef */.i9)(prop)) {
...
{}
    ...
    if (lib_isVue2) {
        ...
        pinia_assign((0,vue_esm_bundler/* toRaw */.ux)(store), setupStore);
    }
...
{}
    ...
    function useStore(pinia, hot) {
        const hasContext = (0,vue_esm_bundler/* hasInjectionContext */.PS)();
        pinia =
            // in test mode, ignore the argument provided as we can always retrieve a
            // pinia instance with getActivePinia()
            ( false ? 0 : pinia) ||
                (hasContext ? (0,vue_esm_bundler/* inject */.WQ)(piniaSymbol, null) : null);
        if (pinia)
            setActivePinia(pinia);
        if (false) // removed by dead control flow
{}
