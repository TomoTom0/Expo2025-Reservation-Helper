...
class MainDialogFabImpl {
     ...
     * 入場日時ボタンを構築（調査結果に基づく）
     */
    buildEntranceDateButtons(schedules) {
    ...
    buildReservationTypes(ticket) {
        ...
        const hasValidReservations = ticket.schedules &&
            ...
            ticket.schedules.some((s) => s.use_state === 0);
        return `
