...
class MainDialogFabImpl {
    ...
    async handleAddTicket() {
        ...
        try {
            ...
            console.log(`🎫 追加されたチケットID: ${ticketId} が含まれているか:`, allTickets.some(t => t.ticket_id === ticketId));
            // 成功時はタブを再初期化
            await this.initializeTicketTab();
            // 入力をクリア
            ticketIdInput.value = '';
